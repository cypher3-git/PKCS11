...
enum pkcs11_ta_cmd {
	/*
	 * PKCS11_CMD_PING	-0	确认 TA 存在并返回版本信息
	 *
	...
	/*
	 * PKCS11_CMD_SLOT_LIST -1  获取有效插槽 ID 的表
	 *
	 * [in]  memref[0] = 32位，未使用，必须为 0
	 * [out] memref[0] = 32位返回码，枚举 pkcs11_rc
	...
	/*
	 * PKCS11_CMD_SLOT_INFO -2 获取 cryptoki 结构化插槽信息
	 *
	...
	/*
	 * PKCS11_CMD_TOKEN_INFO -3 获取 cryptoki 结构化令牌信息
	 *
	 * [in]	 memref[0] = 32位插槽 ID
	 * [out] memref[0] = 32位返回码，枚举 pkcs11_rc
	...
	/*
	 * PKCS11_CMD_MECHANISM_IDS -4 获取支持的机制列表
	 *
	 * [in]	 memref[0] = 32位插槽 ID
	 * [out] memref[0] = 32位返回码，枚举 pkcs11_rc
	...
	/*
	 * PKCS11_CMD_MECHANISM_INFO -5 获取特定机制的信息
	 *
	 * [in]  memref[0] = [
	 *              32位插槽 ID，
	...
	/*
	 * PKCS11_CMD_OPEN_SESSION -6 打开会话
	 *
	 * [in]  memref[0] = [
	 *              32位插槽 ID，
	 *              32位会话标志，
	...
	/*
	 * PKCS11_CMD_CLOSE_SESSION -7 关闭已打开的会话
	 *
	 * [in]  memref[0] = 32位会话句柄
	 * [out] memref[0] = 32位返回码，枚举 pkcs11_rc
	 *
	...
	/*
	 * PKCS11_CMD_CLOSE_ALL_SESSIONS -8 关闭令牌上的所有客户端会话
	 *
	 * [in]	 memref[0] = 32位插槽 ID
	 * [out] memref[0] = 32位返回码，枚举 pkcs11_rc
	 *
	...
	/*
	 * PKCS11_CMD_SESSION_INFO -9 获取会话的 Cryptoki 信息
	 *
	 * [in]  memref[0] = 32位会话句柄
	 * [out] memref[0] = 32位返回码，枚举 pkcs11_rc
	...
	/*
	 * PKCS11_CMD_INIT_TOKEN -10 初始化 PKCS#11 令牌
	 *
	 * [in]  memref[0] = [
	 *              32位插槽 ID，
	 *              32位 PIN 长度，
	...
	/*
	 * PKCS11_CMD_INIT_PIN -11 初始化用户 PIN
	 *
	 * [in]  memref[0] = [
	 *              32位会话句柄，
	 *              32位 PIN 字节大小，
	...
	/*
	 * PKCS11_CMD_SET_PIN -12 更改用户 PIN
	 *
	 * [in]	 memref[0] = [
	 *              32位会话句柄，
	 *              32位旧 PIN 字节大小，
	...
	/*
	 * PKCS11_CMD_CREATE_OBJECT -15 在会话或令牌中创建原始客户端组装对象
	 *
	 *
	 * [in]  memref[0] = [
	 *              32位会话句柄，
	...
	/*
	 * PKCS11_CMD_DESTROY_OBJECT -16 销毁对象
	 *
	 * [in]  memref[0] = [
	 *              32位会话句柄，
	 *              32位对象句柄
	...
	/*
	 * PKCS11_CMD_ENCRYPT_INIT -17 初始化加密处理
	 * PKCS11_CMD_DECRYPT_INIT -18 初始化解密处理
	 *
	 * [in]  memref[0] = [
	 *              32位会话句柄，
	 *              32位密钥的对象句柄，
	...
	/*
	 * PKCS11_CMD_ENCRYPT_UPDATE -19 更新加密处理
	 * PKCS11_CMD_DECRYPT_UPDATE -20 更新解密处理
	 *
	 * [in]  memref[0] = 32位会话句柄
	 * [out] memref[0] = 32位返回码，枚举 pkcs11_rc
	...
	/*
	 * PKCS11_CMD_ENCRYPT_FINAL -21 完成加密处理
	 * PKCS11_CMD_DECRYPT_FINAL -22 完成解密处理
	 *
	 * [in]  memref[0] = 32位会话句柄
	 * [out] memref[0] = 32位返回码，枚举 pkcs11_rc
	 * [out] memref[2] = 输出处理后的数据
	...
	/*
	 * PKCS11_CMD_ENCRYPT_ONESHOT -23 一次性更新并完成加密处理
	 *
	 * PKCS11_CMD_DECRYPT_ONESHOT -24 一次性更新并完成解密处理
	 *
	 *
	 * [in]  memref[0] = 32位会话句柄
	 * [out] memref[0] = 32位返回码，枚举 pkcs11_rc
	...
	/*
	 * PKCS11_CMD_SIGN_INIT   -25 初始化签名计算处理
	 *
	 * PKCS11_CMD_VERIFY_INIT -26 初始化签名验证处理
	 *
	 *
	 * [in]  memref[0] = [
	 *              32位会话句柄，
	...
	/*
	 * PKCS11_CMD_SIGN_UPDATE   -27 更新签名计算处理
	 * PKCS11_CMD_VERIFY_UPDATE -28 更新签名验证处理
	 *
	 * [in]  memref[0] = 32位会话句柄
	 * [out] memref[0] = 32位返回码，枚举 pkcs11_rc
	 * [in]  memref[1] = 要处理的输入数据
	...
	/*
	 * PKCS11_CMD_SIGN_FINAL -29 完成签名计算处理
	 *
	 * [in]  memref[0] = 32位会话句柄
	 * [out] memref[0] = 32位返回码，枚举 pkcs11_rc
	 * [out] memref[2] = 输出签名
	...
	/*
	 * PKCS11_CMD_VERIFY_FINAL -30 完成签名验证处理
	 *
	 *
	 * [in]  memref[0] = 32位会话句柄
	 * [out] memref[0] = 32位返回码，枚举 pkcs11_rc
	...
	/*
	 * PKCS11_CMD_SIGN_ONESHOT -31 一次性计算签名
	 *
	 * [in]  memref[0] = 32位会话句柄
	 * [out] memref[0] = 32位返回码，枚举 pkcs11_rc
	 * [in]  memref[1] = 要处理的输入数据
	...
	/*
	 * PKCS11_CMD_VERIFY_ONESHOT -32 一次性计算并比较签名
	 *
	 * [in]  memref[0] = 32位会话句柄
	 * [out] memref[0] = 32位返回码，枚举 pkcs11_rc
	 * [in]  memref[1] = 要处理的输入数据
	...
	/*
	 * PKCS11_CMD_GENERATE_KEY -33 生成对称密钥或域参数
	 *
	 *
	 * [in]  memref[0] = [
	 *              32位会话句柄，
	...
	/*
	 * PKCS11_CMD_FIND_OBJECTS_INIT -34 初始化对象搜索
	 *
	 * [in]  memref[0] = [
	 *              32位会话句柄，
	 *              (struct pkcs11_object_head)attribs + 属性数据
	...
	/*
	 * PKCS11_CMD_FIND_OBJECTS -35 获取匹配对象的句柄
	 *
	 * [in]  memref[0] = 32位会话句柄
	 * [out] memref[0] = 32位返回码，枚举 pkcs11_rc
	...
	/*
	 * PKCS11_CMD_FIND_OBJECTS_FINAL -36 完成当前对象搜索
	 *
	 * [in]  memref[0] = 32位会话句柄
	 * [out] memref[0] = 32位返回码，枚举 pkcs11_rc
	 *
	...
	/*
	 * PKCS11_CMD_GET_OBJECT_SIZE -37 获取 TEE 中对象使用的字节大小
	 *
	 * [in]  memref[0] = [
	 *              32位会话句柄，
	 *              32位对象句柄
	...
	/*
	 * PKCS11_CMD_GET_ATTRIBUTE_VALUE -38 获取对象属性的值
	 *
	 * [in]  memref[0] = [
	 *              32位会话句柄，
	 *              32位对象句柄，
	...
	/*
	 * PKCS11_CMD_SET_ATTRIBUTE_VALUE -39 设置对象属性的值
	 *
	 * [in]  memref[0] = [
	 *              32位会话句柄，
	 *              32位对象句柄，
	...
	/*
	 * PKCS11_CMD_COPY_OBJECT -40 复制对象，为副本创建新对象
	 *
	 *
	 * [in]  memref[0] = [
	 *              32位会话句柄，
	...
	/*
	 * PKCS11_CMD_SEED_RANDOM -41 为随机数据生成器提供种子
	 *
	 * [in]  memref[0] = 32位会话句柄
	 * [out] memref[0] = 32位返回码，枚举 pkcs11_rc
	...
	/*
	 * PKCS11_CMD_GENERATE_RANDOM -42 生成随机数据
	 *
	 * [in]  memref[0] = 32位会话句柄
	 * [out] memref[0] = 32位返回码，枚举 pkcs11_rc
	...
	/*
	 * PKCS11_CMD_DERIVE_KEY -43 从父密钥派生密钥
	 *
	 * [in]  memref[0] = [
	 *              32位会话句柄，
	 *              32位父密钥句柄，
	...
	/*
	 * PKCS11_CMD_RELEASE_ACTIVE_PROCESSING -44 释放活动处理
	 *
	 * [in]  memref[0] = [
	 *              32位会话句柄，
	 *              32位枚举 pkcs11_ta_cmd
	...
	/*
	 * PKCS11_CMD_DIGEST_INIT -45 初始化摘要计算处理
	 *
	 * [in]  memref[0] = [
	 *              32位会话句柄，
	 *              (struct pkcs11_attribute_head)mechanism + 机制参数
	...
	/*
	 * PKCS11_CMD_DIGEST_KEY -46 使用密钥更新摘要
	 *
	 * [in]  memref[0] = [
	 *              32位会话句柄，
	 *              32位密钥句柄
	...
	/*
	 * PKCS11_CMD_DIGEST_UPDATE -47 使用数据更新摘要
	 *
	 * [in]  memref[0] = 32位会话句柄
	 * [out] memref[0] = 32位返回码，枚举 pkcs11_rc
	 * [in]  memref[1] = 要处理的输入数据
	...
	/*
	 * PKCS11_CMD_DIGEST_FINAL -48 完成摘要计算处理
	 *
	 * [in]  memref[0] = 32位会话句柄
	 * [out] memref[0] = 32位返回码，枚举 pkcs11_rc
	 * [out] memref[2] = 输出摘要
	...
	/*
	 * PKCS11_CMD_DIGEST_ONESHOT -49 一次性计算摘要
	 *
	 * [in]  memref[0] = 32位会话句柄
	 * [out] memref[0] = 32位返回码，枚举 pkcs11_rc
	 * [in]  memref[1] = 要处理的输入数据
	...
	/*
	 * PKCS11_CMD_GENERATE_KEY_PAIR -50 生成非对称密钥对
	 *
	 * [in]  memref[0] = [
	 *              32位会话句柄，
	 *              (struct pkcs11_attribute_head)mechanism + 机制参数，
	...
	/*
	 * PKCS11_CMD_WRAP_KEY -51 包装私钥或密钥
	 *
	 * [in]  memref[0] = [
	 *              32位会话句柄，
	 *              32位包装密钥句柄，
	...
	/*
	 * PKCS11_CMD_UNWRAP_KEY -52 解包已包装的密钥，创建新的
	 *                         私钥或密钥对象
	 *
	 * [in]  memref[0] = [
	 *              32位会话句柄，
